...
$selectopt = $_POST['selectopt'];

$res = mysqli_query($con,"INSERT INTO a_regras_limitador_precos (id,tipo,porcentagem,valor1,valor2,id_conf_regra,ini_limitador,end_limitador) VALUES (NULL,'2','$porcnt_num','$ini_alt_valor_inic','$final_alt_valor_inic','$selectopt','$ini_prod_qtd','$final_prod_qtd')");
